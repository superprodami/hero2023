...
//        absolute_chassis_speed.vw = RAMP_float(Chassis_Follow_PID.f_cal_pid(&Chassis_Follow_PID, Find_Y_AnglePNY(), 0), absolute_chassis_speed.vw, 0.0008); //PID使底盘跟随云台速度
//        break;
...
//            {
//                absolute_chassis_speed.vx  = (Slope_Chassis_Move_Back + Slope_Chassis_Move_Fron) / 3000.0f; //前后计算
//                absolute_chassis_speed.vy  = (Slope_Chassis_Move_Left + Slope_Chassis_Move_Righ) / 3000.0f; //左右计算
//            }
//            else
//            {
//                absolute_chassis_speed.vx  = -(Slope_Chassis_Move_Back + Slope_Chassis_Move_Fron) / 3000.0f; //前后计算
...
////      && Flag_status.Chassis_Switch_Q == 1)//Q按下,切换成扭屁股(不用一直按F)
////  {
...
////      && Flag_status.Chassis_Switch_E == 1)//Q按下,切换成扭屁股(不用一直按F)
////  {
