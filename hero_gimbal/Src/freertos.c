...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of DMGimbalTask */
  osThreadDef(DMGimbalTask, DMGimbalFun, osPriorityHigh, 0, 128);
  DMGimbalTaskHandle = osThreadCreate(osThread(DMGimbalTask), NULL);
...
/* USER CODE BEGIN Header_DMGimbalFun */
/**
* @brief Function implementing the DMGimbalTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_DMGimbalFun */
__weak void DMGimbalFun(void const * argument)
{
  /* USER CODE BEGIN DMGimbalFun */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END DMGimbalFun */
}
